...
public class Usuario {
    ...
    public String getVerifCodigoHash() { return verifCodigoHash; }
    public void setVerifCodigoHash(String verifCodigoHash) { this.verifCodigoHash = verifCodigoHash; }

    public OffsetDateTime getVerifExpiraEn() { return verifExpiraEn; }
    public void setVerifExpiraEn(OffsetDateTime verifExpiraEn) { this.verifExpiraEn = verifExpiraEn; }

    public int getVerifIntentos() { return verifIntentos; }
    public void setVerifIntentos(int verifIntentos) { this.verifIntentos = verifIntentos; }

    public OffsetDateTime getVerifUltimoEnvio() { return verifUltimoEnvio; }
    public void setVerifUltimoEnvio(OffsetDateTime verifUltimoEnvio) { this.verifUltimoEnvio = verifUltimoEnvio; }
}